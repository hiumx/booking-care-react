...
function HeaderDetailPage({ textDetail, isShowText }) {
    ...
    return (
        <div className="header-detail-page-container">
            <div className='header-detail-page-content'>
                <div className='header-detail-back' onClick={handleBackHomePage}>
                    <svg className='header-detail-back-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
